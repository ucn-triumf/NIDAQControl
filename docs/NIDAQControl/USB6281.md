...
- [Usb6281](#usb6281)
  - [USB6281](#usb6281)
    - [USB6281()._draw_in_progress](#usb6281()_draw_in_progress)
    - [USB6281()._make_signal_generator](#usb6281()_make_signal_generator)
    - [USB6281()._read_task_callback](#usb6281()_read_task_callback)
    - [USB6281()._write_task_callback](#usb6281()_write_task_callback)
    - [USB6281().close](#usb6281()close)
    - [USB6281().draw_data](#usb6281()draw_data)
    - [USB6281().draw_intended_output](#usb6281()draw_intended_output)
    - [USB6281().run](#usb6281()run)
    - [USB6281().setup](#usb6281()setup)
    - [USB6281().to_csv](#usb6281()to_csv)
